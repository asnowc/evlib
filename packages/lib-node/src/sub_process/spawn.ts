...
/** @public */
export function spawn(exePath: string, options: SpawnOptions = {}): Promise<SubProcess> {
    return rawSpawn(exePath, options, {}).then((cps) => new SubProcess(cps));
}

/** @public */
export function spawnSync(exePath: string, options: SpawnSyncOptions = {}): SpawnSyncResult {
